...
The converter, as of now, does not handle twos complement arithmetic, nor does it handle floating point. There are plans to implement this functionality in the future.
